/*  Description:  Calculator from https://www.youtube.com/watch?v=EpP6KgJtHTk,
        first time following a tutorial on for kotlin
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //  What setting the text to equal nothing on clicking clear button
        ...
        //  What to do when equals sign is pressed, uses try catch learned before in class
